    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800 rounded-lg p-6">
          <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">{totalNewsletters}</div>
          <div className="text-gray-700 dark:text-gray-300 font-medium">Newsletters</div>
          <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">{sentNewsletters} sent</div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400">Create newsletters and send them to subscribers</p>
        </Link>
